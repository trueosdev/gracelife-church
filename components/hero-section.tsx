  ...
  const videoLink = (extraClassName: string) => (
    ...
    >
      <iframe
        ...
        src="https://www.youtube-nocookie.com/embed/ldiYtoaFAS8?autoplay=1&mute=1&controls=0&loop=1&playlist=ldiYtoaFAS8&playsinline=1&rel=0&modestbranding=1&showinfo=0&disablekb=1&iv_load_policy=3&fs=0&color=white"
    ...
    <section className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center min-h-screen max-w-7xl mx-auto px-6 py-12 md:py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-10 lg:hidden w-100%">
            {videoLink("w-full")}
          </div>
